...
public:
	...
	template<typename T>
	void setAttPointer(GLuint idx, GLint size, GLenum type, GLboolean flip, GLuint stride, GLuint offset, GLuint divisor = 0) {
...
public:
	...
	// draw
	void draw(GLenum mode, GLuint count, GLenum type, GLuint* indices, GLuint instancecount = 1) {
